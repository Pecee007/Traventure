...
/*	  public static void main(String[] args) throws Exception {
		    ...
		    HotelDetail h = new HotelDetail("KEYS2","Experience a Charismatic Experience");
		    //Person p = new Person("Joe", 35);
		    mongoOps.insert(h);
		    h = mongoOps.findById(h.getid(), HotelDetail.class); 
	  ...
	  public static void main(String[] args) throws Exception {
		  ...
		  /*		    ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("MongoConfig.xml");
			HotelDetailRepo hotelRepo = context.getBean(HotelDetailRepo.class);
		    ...
		    Iterable<HotelDetail> hotelName = hotelRepo.searchByHotelName(h.getHotel_name()); 
		    String name = hotelName.toString();
		    System.out.println("Hotel Search by Name: "+name);
		    
		    Iterable<HotelDetail> hotelList = hotelRepo.findAll();
			//List<HotelDetail> hotelList = hotelRepo.findAll(HotelDetail.class);
			int i=0;
		    for(HotelDetail hotel : hotelList){
